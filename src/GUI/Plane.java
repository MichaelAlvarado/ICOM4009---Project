...
public class Plane extends JPanel{
	...
	public void addWall(Point p1, Point p2) {
		//this is assuming p1 and p2 are originated in upper left corner(Remember the display is actually on bottom left)
	...
	public String getWallAutoGeneratedName() {
		return currentBuilding.getName()+"_w" + String.valueOf(walls.size());
	}
		...
		public void mouseReleased(MouseEvent arg0) {
			if(enable) {
				...
				if(currentPointPair[1] != null && currentPointPair[0] != null) {
					...
					Wall wall = new Wall(getWallAutoGeneratedName(), currentPointPair[0], currentPointPair[1]);
					addWall(wall);
				}
