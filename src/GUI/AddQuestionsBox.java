...
public class AddQuestionsBox extends JPanel{
	...
	Plane plane;
	Building building;
	JTextField question, correct, fail1, fail2, fail3;
	JButton enter, exit;
	...
	public AddQuestionsBox(int x, int y, int width, int height, Plane plane) {
		...
		question.setBounds(30, questionLabel.getY()+questionLabel.getHeight(), this.getWidth()-60, 40);
		...
		correct = new JTextField("Correct Option");
		...
		fail1 = new JTextField("Incorrect Option");
		...
		fail2 = new JTextField("Incorrect Option");
		...
		fail3 = new JTextField("Incorrect Option");
